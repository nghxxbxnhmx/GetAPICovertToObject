...
public class MergedObjectModelServiceImpl implements MergedObjectModelService {
        ...
        public MergeObjectModel createMergeObjectModel(ContractModel contract, MacDTO mac, DeviceInfoModel deviceInfo) {
                ...
                mergeObjectModel.setMacContract(getContractListOrDefault(mac.getMacContract()));
                ...
                mergeObjectModel
                                .setLanHostConfigManagementDNSServers(
                                                getValueOrDefault(deviceInfo.lanHostConfigManagementDNSServers));
                mergeObjectModel.setTraceRouteDiagnosticsState(
                                getValueOrDefault(deviceInfo.traceRouteDiagnosticsState));
                mergeObjectModel
                                .setTraceRouteDiagnosticsInterface(
                                                getValueOrDefault(deviceInfo.traceRouteDiagnosticsInterface));
                ...
                mergeObjectModel.setTraceRouteDiagnosticsTimeout(
                                getValueOrDefault(deviceInfo.traceRouteDiagnosticsTimeout));
                ...
                mergeObjectModel
                                .setTraceRouteDiagnosticsMaxHopCount(
                                                getValueOrDefault(deviceInfo.traceRouteDiagnosticsMaxHopCount));
                mergeObjectModel
                                .setTraceRouteDiagnosticsResponseTime(
                                                getValueOrDefault(deviceInfo.traceRouteDiagnosticsResponseTime));
                ...
                mergeObjectModel.setIpPingDiagnosticsInterface(
                                getValueOrDefault(deviceInfo.ipPingDiagnosticsInterface));
                ...
                mergeObjectModel
                                .setIpPingDiagnosticsDataBlockSize(
                                                getValueOrDefault(deviceInfo.ipPingDiagnosticsDataBlockSize));
                mergeObjectModel.setIpPingDiagnosticsDSCP(getValueOrDefault(deviceInfo.ipPingDiagnosticsDSCP));
                mergeObjectModel.setIpPingDiagnosticsSuccessCount(
                                getValueOrDefault(deviceInfo.ipPingDiagnosticsSuccessCount));
                mergeObjectModel.setIpPingDiagnosticsFailureCount(
                                getValueOrDefault(deviceInfo.ipPingDiagnosticsFailureCount));
        ...
        private int getValueOrDefault(int value) {
                return value != 0 ? value : 0;
        }

        private List<MacContractModel> getContractListOrDefault(List<MacContractModel> list) {
