...
public class GetApiServiceImpl implements GetApiService {
    ...
    public ContractDTO getContractFromMac() {
        ...
        // GetContractFromMac macAddressRequestDTO = new
        // GetContractFromMac("a4:81:7a:b1:05:92");
        // try {
    ...
    public MacDTO getMacFromContract() {
        // String apiUrl =
        // "http://systemradiusapi.fpt.vn/api/Mo/GetMacByContract_ObjID";
    ...
    public AllInfoToCpeDTO getAllInfoToCPE() {
        // String apiUrl =
        // "http://acs2.fpt.net/api/bpm/getparametervalues/GetAllInfoToCPE";
