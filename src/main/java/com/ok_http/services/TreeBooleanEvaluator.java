...
public class TreeBooleanEvaluator extends AbstractEvaluator<String> {
    ...
    final static Operator AND = new Operator("and", 2,
            Operator.Associativity.LEFT, 2);
    /** The logical OR operator. */
    final static Operator OR = new Operator("or", 2, Operator.Associativity.LEFT,
            1);
    ...
    protected String evaluate(Operator operator, Iterator<String> operands,
        ...
        String eval = "(" + o1 + " " + operator.getSymbol() + " " + o2 + ")=" +
                result;
        tree.add(eval);
        return eval;
    }
    ...
    public static void main(String[] args) {
        ...
        doIt(evaluator, "T and T  and T or F");
    }
